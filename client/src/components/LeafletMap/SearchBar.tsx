...
export const SearchBar: React.FC = () => {
    ...
    const [searchBarObject, setSearchBarObject] = useState<AddressLabel>();
    let addressLabel = searchBarObject?.label
    ...
    const sendLocation = () => {
        ...
        else if (addressLabel !== "" && addressLabel) {
            console.log("addressLabel: ", addressLabel);
            // converts address to url-friendly string
            const convertedAddress = addressLabel?.split(" ").join("%20");
